...
\usetikzlibrary{intersections, decorations.pathreplacing, arrows.meta, calc}
\usepackage{pgfplots}
...
% Algorithm Env
\usepackage[linesnumbered,lined,vlined,ruled,commentsnumbered,resetcount]{algorithm2e}
...
\declaretheoremstyle[
	...
	mdframed={
			...
			linecolor=RoyalPurple!90!black,
			nobreak=false
		},
	postheadspace = \newline,
]{grayline}
...
\declaretheorem[style=grayline, name=Code, numberwithin=section]{code}
...
\fancypagestyle{plain}{
	\fancyhead[c]{\includesvg[width=0.18 \textwidth]{Figures/ganesh.svg}
	}
...
% \Package hyperref: No autoref name for `thmt@dummyctr
\makeatletter
\newcommand{\thmt@dummyctrautorefname}{Example}
\makeatother
