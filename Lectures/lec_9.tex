...
\begin{code}[Julia Notebook: Verifying the Connection]
    ...
    \begin{itemize}
        ...
        \item It numerically confirms Bellman's Principle by showing that the optimal sub-trajectory from time $k$  is identical to the corresponding slice of the full optimal trajectory.
